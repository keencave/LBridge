/*
   ...
   protocol extensions done by savek-cc in the xbridge Wixel project.
...
/* 
 changes since 170716_1950:
  ...
  V0.0.03:
  - moved BM019 init code (power SPI lines) as requested by @JoernL to avoid accidental power drain 
  - removed code for xbridgeplus protocol (running on RFduino/Simblee, dont work for Arduino)
  - removed code for voltage consumption (#define DB_VOLTAGE)
*/
...
#define N_RELEASE_VERSION       // uncomment to generate a productive LimiTTer version

#define LB_DATETIME "180816_1142"
...
//#define DB_PKT              // uncomment to display BG queue, 'X' command
//#define SIMU_LIVETIME       // uncomment to simulate sensor livetime
//#define HW_BLE              // uncomment to detect BLE conn status with system LED pin connected to arduino pin 2
#define DYNAMIC_TXID          // uncomment to get TXID automatically
//#define DB_NFC_DATA         // uncomment to debug NFC data
//#define SIMU_BG             // uncomment to simulate BG readings from dead sensor, ramp curve
//#define UPDATE_HM1X         // uncomment to use with extreme care! update HM-11
//#define DB_PROCESSING       // uncomment to extended debug output
//#define INIT_WITH_RENEW     // uncomment to send AT+RENEW at BLE init - will kill fake modules as setting them to 115200
//#define SAFETY_RENEW        // uncomment to send AT+RENEW after 30 min of no BLE
...
//  digitalWrite(IRQPin, HIGH); // remove and shift this lines to configNFC() 
                                // to avoid power loss in case of failed initialisation (@JoernL)
