...
#define LB_DATETIME "190319_1631"
#define LB_VERSION "V0.9"        // version number
#define LB_MINOR_VERSION ".0.2a"  // indicates minor version
...
#define HW_BLE                // detect BLE conn status with system LED pin connected to arduino pin 2
