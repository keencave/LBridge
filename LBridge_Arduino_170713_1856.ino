...
#define N_SHOW_QUEUE          // display internal BG readings queue
...
//      print_state(F(" loop ")); Serial.print(ii); Serial.print(F(", index is ")); Serial.print(i/2);
      if (glucosePointer == ii) {
//        print_state(F("ii found ")); Serial.print(ii);
        if (glucosePointer == 0) {
...
#define NFC_READ_RETRY 1      // 170712: changed back to 1, before 5, better redo reading in read_memory
